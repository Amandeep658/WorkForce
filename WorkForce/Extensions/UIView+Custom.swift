...
extension UIView {
    ...
    class func header(size:CGSize, title:String?, textColor:UIColor = .placeholderColor) -> UIView {
        ...
        label.setLabel(title, textColor, .Poppins_Regular, 16)
...
//        return lineView
    ...
    func setGradientBackground() {
        let colorTop =  UIColor(red: 0.2634587288, green: 0.6802290082, blue: 0.8391065001, alpha: 1).cgColor
        let colorBottom = UIColor(red: 0.8039215803, green: 0.8039215803, blue: 0.8039215803, alpha: 1).cgColor
