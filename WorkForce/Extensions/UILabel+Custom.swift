...
extension UILabel {
        ...
        if description.count > 75 {
            if isSeeMore == true {
                ...
                let attributedString = NSMutableAttributedString(string: "(\(textSting)", attributes: [
                    .font: UIFont.setCustom(.Poppins_Regular, 12), .foregroundColor: UIColor.placeholderColor ])
                
                let seeMoreString = NSAttributedString(string: " See More) \(price)/-", attributes: [.font: UIFont.setCustom(.Poppins_Regular, 14),.foregroundColor: UIColor.textColor])
                ...
                let seeMoreString = NSAttributedString(string: " See Less) \(price)/-", attributes: [.font: UIFont.setCustom(.Poppins_Regular, 14),.foregroundColor: UIColor.textColor])
            ...
            let seeMoreString = NSAttributedString(string: " \(price)/-", attributes: [.font: UIFont.setCustom(.Poppins_Regular, 14),.foregroundColor: UIColor.textColor])
    ...
    func setCommentLabel(title: String?, value: String?) {
        let mutable = NSMutableAttributedString(string: "\(title ?? "") ", attributes: [
            ...
            NSAttributedString.Key.font : UIFont.setCustom(.Poppins_Medium, 14)
        ])
        let value = NSAttributedString(string: value ?? "", attributes: [
            NSAttributedString.Key.foregroundColor : UIColor.textColor,
            NSAttributedString.Key.font : UIFont.setCustom(.Poppins_Medium, 13)
        ])
        mutable.append(value)
        self.attributedText = mutable
    }
    ...
    func setMediumFont(_ text:String, _ textColor:UIColor) {
        self.setLabel(text, textColor, .Poppins_Regular, 15)
    }
