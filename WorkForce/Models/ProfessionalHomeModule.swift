...
import Foundation
struct ProfessionalHomeModule : Codable {
    let status : Int?
    let message : String?
    let data : [ProfessionalHomeData]?
    ...
    init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent([ProfessionalHomeData].self, forKey: .data)
    }
}
struct ProfessionalHomeData : Codable {
    let user_id : String?
    let username : String?
    ...
    let job_type : String?
    let catagory_details : [ProfessionalCatagory_details]?
    ...
    init(from decoder: Decoder) throws {
        ...
        catagory_details = try values.decodeIfPresent([ProfessionalCatagory_details].self, forKey: .catagory_details)
    }

}
struct ProfessionalCatagory_details : Codable {
    let id : String?
    let user_id : String?
    let cat_id : String?
