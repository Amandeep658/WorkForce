...
import Foundation
struct BusinessHomemodule : Codable {
    let status : Int?
    let message : String?
    let data : [BusinessHomeData]?
    ...
    init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent([BusinessHomeData].self, forKey: .data)
    }

}
struct BusinessHomeData : Codable {
    let user_id : String?
    let username : String?
