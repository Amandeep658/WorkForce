//
//  BusinessConnectModel.swift
//  WorkForce
//
//  Created by Aman's MacBookPro on 19/07/22.
//

import Foundation
struct BusinessConnectComapnyModel : Codable {
    let status : Int?
    let message : String?
    let data : [BusinessConnectCompanyListData]?
    ...
    init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent([BusinessConnectCompanyListData].self, forKey: .data)
    }
...
struct BusinessConnectCompanyListData : Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        catagory_details = try values.decodeIfPresent([BusinessConnectCompanyCatagory_details].self, forKey: .catagory_details)
    }
