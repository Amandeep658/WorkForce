...
import Foundation
struct ITServiceModel : Codable {
    let status : Int?
    let message : String?
    let data : ITServiceData?
    ...
    init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent(ITServiceData.self, forKey: .data)
    }

}
struct ITServiceData : Codable {
    let user_id : String?
    let username : String?
    ...
    let job_type : String?
    let category_details : [ITServiceCategory_details]?
    let job_details : [ITJob_details]?
    ...
    init(from decoder: Decoder) throws {
        ...
        category_details = try values.decodeIfPresent([ITServiceCategory_details].self, forKey: .category_details)
        job_details = try values.decodeIfPresent([ITJob_details].self, forKey: .job_details)
    }

}
struct ITServiceCategory_details : Codable {
    let id : String?
    let user_id : String?
    let cat_id : String?
