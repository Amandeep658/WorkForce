...
import Foundation
struct CompanyListingModel : Codable {
    let status : Int?
    let message : String?
    let data : CompanyListingData?
    ...
    init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent(CompanyListingData.self, forKey: .data)
    }

}
struct CompanyListingData : Codable {
    let user_id : String?
    let username : String?
