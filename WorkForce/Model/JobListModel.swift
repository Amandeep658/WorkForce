...
struct JobListModel : Decodable {
    ...
    init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent(JobListData.self, forKey: .data)
    }
...
struct JobListData : Decodable {
    ...
    let catagory_details : [JobCatagory_details]?
    ...
    init(from decoder: Decoder) throws {
        ...
        catagory_details = try values.decodeIfPresent([JobCatagory_details].self, forKey: .catagory_details)
    }

}
struct JobCatagory_details : Decodable {
    let id : String?
    let user_id : String?
    let cat_id : String?
