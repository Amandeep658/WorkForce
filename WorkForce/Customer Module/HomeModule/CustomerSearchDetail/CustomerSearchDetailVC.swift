...
class CustomerSearchDetailVC: UIViewController {
    ...
    func hitCustomerDetail(){
        ...
        print(headers)
        let parameter = ["user_id":anyId] as [String : Any]
        print(parameter)
    ...
    func hitCompanyLike(){
        ...
        let headers: HTTPHeaders = ["Token":authToken]
        print(headers)
        let parameters = ["company_id": anyId , "user_id" : UserDefaults.standard.string(forKey: "uID") ?? ""]
        print(parameters)
